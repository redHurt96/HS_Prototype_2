    ...
    public class IntegrationManager : EditorWindow
    {
        ...
        void OnGUI()
        {
            ...
            AddIntegration("GameCreator V2", "Catsoft Works",
                "https://assetstore.unity.com/packages/tools/game-toolkits/game-creator-2-203069", "EBS_GAMECREATORV2", "GameCreator V2 Integration", null, null);

            AddIntegration("Mirror", "Vis2k",
                "https://assetstore.unity.com/packages/tools/network/mirror-129321", "EBS_MIRROR", "Mirror Integration", null, null);

            AddIntegration("PUN V2", "Exit Games",
                "https://assetstore.unity.com/packages/tools/network/pun-2-free-119922", "EBS_PUNV2", "PUN V2 Integration", null, null);
            ...
            AddIntegration("uSurvival", "Vis2k",
                "https://assetstore.unity.com/packages/templates/systems/usurvival-multiplayer-survival-95015", "EBS_USURVIVAL", "uSurvival Integration", null, null);

            AddIntegration("RPGBuilder", "Blink",
                "https://assetstore.unity.com/packages/tools/game-toolkits/rpg-builder-177657", "EBS_RPG_BUILDER", "RPGBuilder Integration", null, null);
        ...
        void AddIntegration(string name, string author, string link, string defName, string path, Action onEnable, Action onDisable)
        {
